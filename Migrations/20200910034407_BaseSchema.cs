    ...
    public partial class BaseSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 9, 11, 12, 0, 0, 0, DateTimeKind.Unspecified), "Come join us for an exciting game of Bingo with great prizes.", "Bingo" });

            migrationBuilder.InsertData(
                table: "PortalActivity",
                columns: new[] { "Id", "Date", "Description", "Name" },
                values: new object[] { 2, new DateTime(2020, 9, 14, 18, 0, 0, 0, DateTimeKind.Unspecified), "Meet us at the Shuffleboard court!", "Shuffleboard Competition" });
